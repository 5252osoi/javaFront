...
console.log('--------------필터-------------------');
arr2.filter((data,idx) => idx%2==0).map((data,idx) => console.log( data, ":", idx));

const arr3=[10,8,20,15,11,17];    //문자형식으로 비교해서 가장 앞자리만 비교함..
console.log('==============원본데이터=================');
console.log("arr3 :", arr3);
console.log('---------------sort비교-----------------');

// 오름차순 정렬 sort() ==>문자형식으로 정렬 . . .
let res3 = arr3.sort();
